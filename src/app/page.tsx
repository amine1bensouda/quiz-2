...
import { getCourseStatsByTestType } from '@/lib/course-service';
...
export default async function HomePage() {
  const [quizs, stats, courseStats] = await Promise.all([
    getAllQuiz(),
    getStats(),
    getCourseStatsByTestType(),
  ]);
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            {/* Titre principal avec couleurs différentes */}
            ...
            {/* Sous-titre avec examens en couleurs */}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/quiz"
                className="inline-flex items-center gap-2 px-10 py-5 text-lg font-semibold bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
              ...
              <Link
                href="/about-us"
                className="inline-flex items-center gap-2 px-10 py-5 text-lg font-semibold bg-white text-gray-900 rounded-xl hover:bg-gray-50 border-2 border-gray-300 transition-all duration-300 shadow-md hover:shadow-lg"
              >
                Learn More
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="backdrop-blur-xl bg-white/90 rounded-3xl p-8 shadow-2xl border border-white/40 hover:shadow-3xl hover:scale-105 transition-all duration-300">
                <div className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent mb-2">
                  {formatNumber(stats.total_quiz)}
                </div>
                <div className="text-gray-600 font-semibold">Available Quizzes</div>
              </div>
              <div className="backdrop-blur-xl bg-white/90 rounded-3xl p-8 shadow-2xl border border-white/40 hover:shadow-3xl hover:scale-105 transition-all duration-300">
                ...
                <div className="text-gray-600 font-semibold">Practice Questions</div>
              </div>
              <div className="backdrop-blur-xl bg-white/90 rounded-3xl p-8 shadow-2xl border border-white/40 hover:shadow-3xl hover:scale-105 transition-all duration-300">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-cyan-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-6">
                How The School of Mathematics Helps You Score Higher
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-8 rounded-3xl backdrop-blur-xl bg-white/70 hover:bg-white/90 shadow-2xl border border-white/30 hover:shadow-3xl hover:scale-105 transition-all duration-300 group">
                <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg transform group-hover:rotate-6 transition-transform duration-300">
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-4">Practice Real Exam Questions</h3>
              ...
              <div className="text-center p-8 rounded-3xl backdrop-blur-xl bg-white/70 hover:bg-white/90 shadow-2xl border border-white/30 hover:shadow-3xl hover:scale-105 transition-all duration-300 group">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg transform group-hover:rotate-6 transition-transform duration-300">
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-4">Understand What Matters</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="text-center p-8 rounded-3xl backdrop-blur-xl bg-white/70 hover:bg-white/90 shadow-2xl border border-white/30 hover:shadow-3xl hover:scale-105 transition-all duration-300 group">
                <div className="w-20 h-20 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg transform group-hover:rotate-6 transition-transform duration-300">
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-4">Train Like Test Day</h3>
                <p className="text-gray-700 leading-relaxed">
      ...
      <section className="relative py-20 bg-gradient-to-br from-slate-50 via-violet-50 to-rose-50 overflow-hidden">
        <AnimatedShapes variant="floating" count={7} intensity="medium" />
        <BackgroundPattern variant="circular" opacity={0.12} />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-slate-900 via-violet-900 to-rose-900 bg-clip-text text-transparent mb-6">
                Why Students Use The School of Mathematics
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="backdrop-blur-xl bg-white/80 p-8 rounded-3xl shadow-2xl border border-white/40 hover:shadow-3xl hover:scale-105 transition-all duration-300 group">
                ...
                <h3 className="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-3">Exam-Accurate Math Practice</h3>
                <p className="text-gray-700 leading-relaxed">
                  Solve ACT, SAT, AP, and GCSE-style math problems written to match real test difficulty and format.
                </p>
              </div>
              ...
              <div className="backdrop-blur-xl bg-white/80 p-8 rounded-3xl shadow-2xl border border-white/40 hover:shadow-3xl hover:scale-105 transition-all duration-300 group">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-3">Difficulty That Matches the Test</h3>
                <p className="text-gray-700 leading-relaxed">
                  Each problem focuses on high-frequency exam concepts, not random math theory.
                </p>
              </div>
              ...
              <div className="backdrop-blur-xl bg-white/80 p-8 rounded-3xl shadow-2xl border border-white/40 hover:shadow-3xl hover:scale-105 transition-all duration-300 group">
                <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-3">Concept-Focused Learning</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="backdrop-blur-xl bg-white/80 p-8 rounded-3xl shadow-2xl border border-white/40 hover:shadow-3xl hover:scale-105 transition-all duration-300 group">
                <div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-3">Unlimited Free Practice</h3>
                <p className="text-gray-700 leading-relaxed">
      ...
      <section className="relative py-20 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-emerald-900 via-teal-900 to-cyan-900 bg-clip-text text-transparent mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={index} className="backdrop-blur-xl bg-white/80 p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/40 hover:scale-105 hover:bg-white/90">
                  <h3 className="text-lg font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-3">{item.title}</h3>
      ...
      <section className="relative py-20 bg-gradient-to-br from-white via-indigo-50 to-purple-50 overflow-hidden">
        <AnimatedShapes variant="floating" count={7} intensity="medium" />
        <BackgroundPattern variant="grid" opacity={0.1} />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-12">
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-900 bg-clip-text text-transparent">
                Featured Quizzes
              </h2>
              <Link
                href="/quiz"
                className="backdrop-blur-xl bg-white/80 hover:bg-white/90 text-gray-900 hover:text-gray-700 font-semibold text-lg flex items-center gap-2 group px-6 py-3 rounded-xl border border-white/40 hover:border-white/60 shadow-lg hover:shadow-xl transition-all duration-300"
              >
                View All
            ...
            {featuredQuizs.length > 0 ? (
              ...
              <div className="text-center py-16 backdrop-blur-xl bg-white/60 rounded-3xl shadow-2xl border border-white/40">
                <div className="text-6xl mb-4">📚</div>
                <p className="text-gray-700 text-lg font-semibold">No quizzes available at the moment.</p>
              </div>
            )}
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="relative py-20 bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto backdrop-blur-sm bg-white/10 rounded-2xl p-6">
            ...
            <Link
              href="/quiz"
              className="inline-flex items-center gap-3 px-10 py-5 text-lg font-semibold bg-gradient-to-r from-white to-gray-100 text-gray-900 rounded-2xl hover:from-gray-100 hover:to-white transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-105 transform"
            >
